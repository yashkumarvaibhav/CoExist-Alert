  ...
  return (
    <>
      <button
        ...
        className="flex h-11 items-center gap-2 rounded-md border border-line px-2 text-sm text-muted transition-colors hover:bg-hover sm:px-3"
      >
                          ...
                          <li key={item.id}>
                            ...
                            >
                              <span className="min-w-0 flex-1 truncate">
                                {item.label}
                                {item.hint && (
                                  <span className="ml-2 text-xs text-faint">{item.hint}</span>
                                )}
                              </span>
                              {item.href && (
